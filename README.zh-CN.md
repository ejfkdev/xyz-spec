...
| 文档 | 内容 |
|---|---|
| [spec.md](spec.md) | **规范性契约**（v0.2.0）：定义词汇表、类型、默认值、校验、调用管线、错误分类学、渲染、三个前端、根派发器、嵌入面、体验约定、治理。RFC 2119 措辞。 |
...
| SDK | 包 | 目标规范版本 | 备注 |
|---|---|---|---|
| [xyz-go](https://github.com/ejfkdev/xyz-go) | `github.com/ejfkdev/xyz-go`（v0.3.0+） | v0.2.0（基线锚点） | Go 参考实现 |
| [xyz-rust](https://github.com/ejfkdev/xyz-rust) | crates.io `xyz-rust` 0.2.0 | v0.2.0（基线锚点） | Rust 参考实现 |
